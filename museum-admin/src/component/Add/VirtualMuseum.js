            ...
            <div>
                ...
                <div>
                    <Button variant='contained' color='primary' onClick={()=>{
                        if(selected===-1)
                            addData({search: search, sort: sort, page: page, name: 'Виртуальный музей', file: file, data: {name_ru: name_ru, name_kg: name_kg, name_eng: name_eng, }});
                        else
                            setData({oldFile: data[selected][0], id: data[selected][5], search: search, sort: sort, page: page, name: 'Виртуальный музей', file: file, data: {name_ru: name_ru, name_kg: name_kg, name_eng: name_eng}});
                        setSelected(-1)
